...
def generate_sample_data(
    ...
    for season in seasons:
        ...
        season_strength = {
            t: base_strength[t] + rng.normal(0, 0.2) 
            for t in teams
        }
        ...
        for _ in range(per_season):
            ...
            home_score = max(0, int((base_total / 2) + (actual_margin / 2) + rng.normal(0, 4)))
            away_score = max(0, int((base_total / 2) - (actual_margin / 2) + rng.normal(0, 4)))
