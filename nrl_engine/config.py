...
class Config:
    ...
    feature_exclude: List[str] = field(default_factory=lambda: [
        "match_id", "date", "season", "home_team", "away_team",
        "home_score", "away_score", "home_win",
        "home_odds_close", "away_odds_close", "home_odds_open", "away_odds_open",
        "asof_ts", "feature_version", "venue", "referee"
    ])
