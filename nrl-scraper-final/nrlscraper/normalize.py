...
TEAM_ALIASES: dict[str, list[str]] = {
    ...
    'Canterbury Bulldogs': [
        'bulldogs', 'canterbury', 'canterbury bankstown',
        'canterbury-bankstown', 'canterbury bankstown bulldogs',
    ],
    'Cronulla Sharks': [
    ...
    'Manly Sea Eagles': [
        'sea eagles', 'manly', 'manly warringah',
        'manly-warringah', 'manly warringah sea eagles',
    ],
    'Melbourne Storm': ['storm', 'melbourne'],
    'Newcastle Knights': ['knights', 'newcastle'],
    'New Zealand Warriors': [
        'warriors', 'new zealand', 'nz warriors', 'auckland warriors',
    ],
    'North Queensland Cowboys': [
        'cowboys', 'north queensland', 'north qld', 'nth qld', 'nq cowboys',
    ],
    'Parramatta Eels': ['eels', 'parramatta', 'parra'],
    'Penrith Panthers': ['panthers', 'penrith'],
    'South Sydney Rabbitohs': [
        'rabbitohs', 'south sydney', 'souths', 'bunnies',
    ],
    'St George Illawarra Dragons': [
        'dragons', 'st george', 'st george illawarra',
        'st geo illa', 'sgi', 'saints',
    ],
    'Sydney Roosters': [
        'roosters', 'sydney', 'eastern suburbs', 'easts', 'sydney city roosters',
    ],
...
VENUE_ALIASES: dict[str, list[str]] = {
    ...
    'Accor Stadium': [
        'accor', 'accor stadium', 'stadium australia',
        'anz stadium', 'homebush', 'olympic stadium', 'telstra stadium',
    ],
    'AAMI Park': ['aami', 'aami park', 'melbourne rectangular'],
    'CommBank Stadium': [
        'commbank', 'commbank stadium', 'bankwest', 'bankwest stadium',
        'parramatta stadium', 'western sydney stadium',
    ],
    '4 Pines Park': [
        '4 pines', '4 pines park', 'brookvale', 'brookvale oval', 'lottoland',
    ],
    'BlueBet Stadium': [
        'bluebet', 'bluebet stadium', 'penrith stadium',
        'panthers stadium', 'pepper stadium', 'penrith park',
    ],
    'PointsBet Stadium': [
        'pointsbet', 'pointsbet stadium', 'sharks stadium', 'shark park',
        'southern cross group stadium', 'toyota stadium',
    ],
    'McDonald Jones Stadium': [
        'mcdonald jones', 'mcdonald jones stadium', 'mcd jones',
        'newcastle stadium', 'hunter stadium', 'energyaustralia stadium',
    ],
    'Queensland Country Bank Stadium': [
        'qld country bank', 'queensland country bank stadium',
        'qcb stadium', 'qcb', 'townsville stadium',
        '1300smiles', '1300smiles stadium', 'dairy farmers',
    ],
    'Cbus Super Stadium': [
        'cbus', 'cbus super stadium', 'robina', 'robina stadium',
        'skilled park', 'metricon stadium', 'heritage bank stadium',
    ],
    'Go Media Stadium': [
        'go media', 'go media stadium', 'mt smart', 'mt smart stadium',
    ...
    'Netstrata Jubilee Stadium': [
        'netstrata', 'netstrata jubilee', 'netstrata jubilee stadium',
        'kogarah', 'kogarah oval', 'jubilee oval', 'oki jubilee',
    ],
    'Campbelltown Stadium': [
        'campbelltown', 'campbelltown stadium', 'campbelltown sports stadium',
    ],
    'Leichhardt Oval': ['leichhardt', 'leichhardt oval'],
    'Allianz Stadium': [
        'allianz', 'allianz stadium', 'sfs', 'sydney football stadium', 'moore park',
    ],
...
def normalize_venue(s: str) -> Optional[str]:
    """
